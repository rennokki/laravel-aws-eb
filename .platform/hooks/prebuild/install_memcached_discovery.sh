...
# Change `7.X` from below with your PHP version.
# Currently, 7.4 is not supported. Please see
# the official repo: https://github.com/awslabs/aws-elasticache-cluster-client-memcached-for-php
